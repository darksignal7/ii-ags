...
export default ({
    ...
    if (roundedCorners == true){
        //widget.children = [eventwidget, RoundedCorner('topright', {className: 'corner'})]
    }else {
        //widget.children = [eventwidget]
    }
    ...
    const notificationInnerBox = Box({
    ...
    const notificationContent = Box({
        ...props,
        className: `popup-notif-${notifObject.urgency}-inner`,
        children: [
    ...
    if (roundedCorners == true){
        //notificationBox.children= [RoundedCorner('topright', {className: 'corner'}),notificationContent];
    }else {
        //notificationBox.children= [notificationContent];
    }
    eventwidget.add(notificationBox);
