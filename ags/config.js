...
// Widgets
import { Bar, BarCornerTopleft, BarCornerTopright,BarCornerBottomleft,BarCornerBottomright ,BarTop, BarBottom , BarRight} from './modules/bar/main.js';
...
import { GeneralInner } from './modules/inner-shadow/main.js';
...
const Windows = () => [
    ...
    forMonitors(Session),
    forMonitors(BarTop),
    forMonitors(GeneralInner),
    forMonitors(BarBottom),
    forMonitors(BarRight),
    ...(userOptions.dock.enabled ? [forMonitors(Dock)] : []),
    ...(userOptions.appearance.fakeScreenRounding !== 1 ? [
